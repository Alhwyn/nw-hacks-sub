    ...
    return __awaiter(this, arguments, undefined, function(kind) {
      ...
      return function* () {
        ...
        while (new Date().getTime() < endTime) {
          if (transport.isICEConnected && ((_a = _this3.dataChannelForKind(kind, subscriber)) === null || _a === undefined ? undefined : _a.readyState) === "open") {
            return;
          }
          yield sleep(50);
        }
...
class LocalParticipant extends Participant {
  ...
  performRpc(_ref3) {
    ...
    return new TypedPromise((resolve, reject) => __awaiter(this, undefined, undefined, function* () {
      ...
      if (((_b = (_a = this.engine.latestJoinResponse) === null || _a === undefined ? undefined : _a.serverInfo) === null || _b === undefined ? undefined : _b.version) && compareVersions((_d = (_c = this.engine.latestJoinResponse) === null || _c === undefined ? undefined : _c.serverInfo) === null || _d === undefined ? undefined : _d.version, "1.8.0") < 0) {
    ...
    try {
      ...
      this.localParticipant.trackPublications.forEach((pub) => {
        ...
        if (shouldStopTracks) {
          ...
          (_b2 = pub.track) === null || _b2 === undefined || _b2.stop();
        } else {
      ...
      if (isWeb()) {
        ...
        (_b = (_a = navigator.mediaDevices) === null || _a === undefined ? undefined : _a.removeEventListener) === null || _b === undefined || _b.call(_a, "devicechange", this.handleDeviceChange);
      }
    } finally {
    ...
    return __awaiter(this, undefined, undefined, function* () {
      ...
      if (publishOptions.video) {
        const camPub = new LocalTrackPublication(Track.Kind.Video, new TrackInfo({
          ...
          name: "video-dummy"
        }), new LocalVideoTrack(publishOptions.useRealTracks && ((_a = window.navigator.mediaDevices) === null || _a === undefined ? undefined : _a.getUserMedia) ? (yield window.navigator.mediaDevices.getUserMedia({
          video: true
        })).getVideoTracks()[0] : createDummyVideoStreamTrack(160 * ((_b = participantOptions.aspectRatios[0]) !== null && _b !== undefined ? _b : 1), 160, true, true), undefined, false, {
          loggerName: this.options.loggerName,
          loggerContextCb: () => this.logContext
        }), {
          loggerName: this.options.loggerName,
...
function o2() {
  return o2 = Object.assign ? Object.assign.bind() : function(e2) {
    for (var t = 1;t < arguments.length; t++) {
      var n = arguments[t];
      for (var s in n)
        ({}).hasOwnProperty.call(n, s) && (e2[s] = n[s]);
    }
    return e2;
...
class i {
  static getFullOptions(e2) {
    return o2({ clientTools: {}, onConnect: () => {}, onDebug: () => {}, onDisconnect: () => {}, onError: () => {}, onMessage: () => {}, onAudio: () => {}, onModeChange: () => {}, onStatusChange: () => {}, onCanSendFeedbackChange: () => {} }, e2);
  }
  constructor(e2, t) {
    var n = this;
    this.options = undefined, this.connection = undefined, this.lastInterruptTimestamp = 0, this.mode = "listening", this.status = "connecting", this.volume = 1, this.currentEventId = 1, this.lastFeedbackEventId = 1, this.canSendFeedback = false, this.endSessionWithDetails = async function(e3) {
      n.status !== "connected" && n.status !== "connecting" || (n.updateStatus("disconnecting"), await n.handleEndSession(), n.updateStatus("disconnected"), n.options.onDisconnect(e3));
  ...
  async handleClientToolCall(e2) {
    if (Object.prototype.hasOwnProperty.call(this.options.clientTools, e2.client_tool_call.tool_name))
      try {
        var t;
        const n = (t = await this.options.clientTools[e2.client_tool_call.tool_name](e2.client_tool_call.parameters)) != null ? t : "Client tool execution successful.", s = typeof n == "object" ? JSON.stringify(n) : String(n);
...
class r2 {
  constructor(e2 = {}) {
    this.queue = [], this.disconnectionDetails = null, this.onDisconnectCallback = null, this.onMessageCallback = null, this.onDebug = undefined, this.onDebug = e2.onDebug;
  }
  debug(e2) {
...
function h2(e2) {
  const t = { type: d };
  var n, s, o3, a2, i2;
  return e2.overrides && (t.conversation_config_override = { agent: { prompt: (n = e2.overrides.agent) == null ? undefined : n.prompt, first_message: (s = e2.overrides.agent) == null ? undefined : s.firstMessage, language: (o3 = e2.overrides.agent) == null ? undefined : o3.language }, tts: { voice_id: (a2 = e2.overrides.tts) == null ? undefined : a2.voiceId }, conversation: { text_only: (i2 = e2.overrides.conversation) == null ? undefined : i2.textOnly } }), e2.customLlmExtraBody && (t.custom_llm_extra_body = e2.customLlmExtraBody), e2.dynamicVariables && (t.dynamic_variables = e2.dynamicVariables), e2.userId && (t.user_id = e2.userId), t;
}

class p extends r2 {
  constructor(e2, t, n, s) {
    super(), this.socket = undefined, this.conversationId = undefined, this.inputFormat = undefined, this.outputFormat = undefined, this.socket = e2, this.conversationId = t, this.inputFormat = n, this.outputFormat = s, this.socket.addEventListener("error", (e3) => {
  ...
  static async create(e2) {
    ...
    try {
      ...
      let i2;
      const r3 = ((s = e2.overrides) == null || (s = s.client) == null ? undefined : s.version) || l, d2 = ((o3 = e2.overrides) == null || (o3 = o3.client) == null ? undefined : o3.source) || "js_sdk";
      if (e2.signedUrl) {
        const t2 = e2.signedUrl.includes("?") ? "&" : "?";
        i2 = `${e2.signedUrl}${t2}source=${d2}&version=${r3}`;
      } else
        i2 = `${a3}/v1/convai/conversation?agent_id=${e2.agentId}&source=${d2}&version=${r3}`;
      const m = ["convai"];
      e2.authorization && m.push(`bearer.${e2.authorization}`), t = new WebSocket(i2, m);
      const g = await new Promise((n2, s2) => {
        t.addEventListener("open", () => {
          var n3;
          const s3 = h2(e2);
          (n3 = t) == null || n3.send(JSON.stringify(s3));
        }, { once: true }), t.addEventListener("error", (e3) => {
          setTimeout(() => s2(e3), 0);
        }), t.addEventListener("close", s2), t.addEventListener("message", (e3) => {
          const t2 = JSON.parse(e3.data);
          u(t2) && (t2.type === "conversation_initiation_metadata" ? n2(t2.conversation_initiation_metadata_event) : console.warn("First received message is not conversation metadata."));
        }, { once: true });
      }), { conversation_id: v, agent_output_audio_format: f, user_input_audio_format: w } = g, y = c(w != null ? w : "pcm_16000"), _2 = c(f);
      return new p(t, v, y, _2);
    } catch (e3) {
      var a2;
...
class m extends r2 {
  constructor(e2, t, n, s, o3 = {}) {
    super(o3), this.conversationId = undefined, this.inputFormat = undefined, this.outputFormat = undefined, this.room = undefined, this.isConnected = false, this.room = e2, this.conversationId = t, this.inputFormat = n, this.outputFormat = s, this.setupRoomEventListeners();
  }
  static async create(n) {
    let s;
    if ("conversationToken" in n && n.conversationToken)
      s = n.conversationToken;
    else {
      if (!("agentId" in n) || !n.agentId)
        throw new Error("Either conversationToken or agentId is required for WebRTC connection");
      try {
        var o3, a2;
        const e2 = ((o3 = n.overrides) == null || (o3 = o3.client) == null ? undefined : o3.version) || l, t = ((a2 = n.overrides) == null || (a2 = a2.client) == null ? undefined : a2.source) || "js_sdk", i3 = `https://api.elevenlabs.io/v1/convai/conversation/token?agent_id=${n.agentId}&source=${t}&version=${e2}`, r3 = await fetch(i3);
        if (!r3.ok)
          throw new Error(`ElevenLabs API returned ${r3.status} ${r3.statusText}`);
        if (s = (await r3.json()).token, !s)
    ...
    const i2 = new Room;
    try {
      const e2 = `webrtc-${Date.now()}`, o4 = c("pcm_48000"), a3 = c("pcm_48000"), r3 = new m(i2, e2, o4, a3, n), l2 = n.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
...
async function f(e2 = { default: 0, android: 3000 }) {
  let t = e2.default;
  var n;
...
class w extends i {
  static async startSession(e2) {
    ...
    let n = null;
    try {
      return await f(t.connectionDelay), n = await g(e2), new w(t, n);
    } catch (e3) {
      var s;
      throw t.onStatusChange({ status: "disconnected" }), (s = n) == null || s.close(), e3;
    }
  }
}
function y(e2) {
...
class S {
  static async create({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n }) {
    ...
    try {
      ...
      return l2.port.postMessage({ type: "setFormat", format: t, sampleRate: e2 }), c2.connect(r3), r3.connect(l2), await s.resume(), new S(s, r3, l2, o3);
    } catch (e3) {
      var a2, i2;
      throw (a2 = o3) == null || a2.getTracks().forEach((e4) => e4.stop()), (i2 = s) == null || i2.close(), e3;
    }
  }
  constructor(e2, t, n, s) {
    this.context = undefined, this.analyser = undefined, this.worklet = undefined, this.inputStream = undefined, this.context = e2, this.analyser = t, this.worklet = n, this.inputStream = s;
  }
  async close() {
...
class I {
  static async create({ sampleRate: e2, format: t }) {
    ...
    try {
      ...
      return a2.port.postMessage({ type: "setFormat", format: t }), a2.connect(o3), await n.resume(), new I(n, s2, o3, a2);
    } catch (e3) {
      var s;
      throw (s = n) == null || s.close(), e3;
    }
  }
  constructor(e2, t, n, s) {
    this.context = undefined, this.analyser = undefined, this.gain = undefined, this.worklet = undefined, this.context = e2, this.analyser = t, this.gain = n, this.worklet = s;
  }
  async close() {
...
class F extends i {
  static async startSession(e2) {
    ...
    try {
      var u2;
      return c2 = await navigator.mediaDevices.getUserMedia({ audio: true }), await f(n.connectionDelay), a2 = await g(e2), [s, r3] = await Promise.all([S.create(o2({}, a2.inputFormat, { preferHeadphonesForIosDevices: e2.preferHeadphonesForIosDevices })), I.create(a2.outputFormat)]), (u2 = c2) == null || u2.getTracks().forEach((e3) => e3.stop()), c2 = null, new F(n, a2, s, r3, l2);
    } catch (e3) {
      var d2, h3, p2, m2;
      n.onStatusChange({ status: "disconnected" }), (d2 = c2) == null || d2.getTracks().forEach((e4) => e4.stop()), (h3 = a2) == null || h3.close(), await ((p2 = s) == null ? undefined : p2.close()), await ((m2 = r3) == null ? undefined : m2.close());
      try {
        var v2;
  ...
  constructor(e2, t, n, s, o3) {
    super(e2, t), this.input = undefined, this.output = undefined, this.wakeLock = undefined, this.inputFrequencyData = undefined, this.outputFrequencyData = undefined, this.onInputWorkletMessage = (e3) => {
      this.status === "connected" && this.connection.sendMessage({ user_audio_chunk: y(e3.data[0].buffer) });
  ...
  getOutputByteFrequencyData() {
    return this.outputFrequencyData != null || (this.outputFrequencyData = new Uint8Array(this.output.analyser.frequencyBinCount)), this.output.analyser.getByteFrequencyData(this.outputFrequencyData), this.outputFrequencyData;
  }
  getInputVolume() {
...
var currentScreenContext = null;
var screenViewPermissionGranted = false;
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function startConversation() {
    ...
    try {
      ...
      conversation = await x.startSession({
        signedUrl,
